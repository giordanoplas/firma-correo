...
<p align="center">
 ...
 - Este es un Proyecto hecho en React(frontend) y NestJS(backend). Este hace interacción con una base de datos MySQL. Además genera la firma de correo especificada para una empresa.
<p align="center">
